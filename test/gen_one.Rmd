...
np$save(file.path(params$out_dir, str_c("x-", B,"-",j, ".npy")), patch$x)
np$save(file.path(params$out_dir, str_c("y-", B,"-",j, ".npy")), patch_y)
write_sf(patch$meta, file.path(params$out_dir, str_c("geo-", B,"-",j, ".geojson")))
```
Write all results.
