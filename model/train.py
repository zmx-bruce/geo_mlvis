...
def loss(y_hat, y, params, device, smooth=0.2, weights=[0.9, 0.9, 0.1], lambda_reg=0.0005):#[0.6, 0.9, 0.2]
...
def dice_bce_loss(y_hat, y, device, smooth=0.2, weights=[0.9, 0.9, 0.1]):#[0.6, 0.9, 0.2]
    y_hat = y_hat.view(-1)
    y = y.view(-1)
    import pdb
    pdb.set_trace()
