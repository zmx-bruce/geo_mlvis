...
params:
  ...
  y_path: "vsicurl/https://uwmadison.box.com/shared/static/xmao8ovibuuqy71nezveylb35ugpq2fo.geojson"
...
np$save(file.path(out_dir, str_c("x-test",params$B, ".npy")), patch$x)
np$save(file.path(out_dir, str_c("x_equal-test",params$B, ".npy")), patch$x_equal)
np$save(file.path(out_dir, str_c("y-test",params$B,".npy")), patch_y)
```
