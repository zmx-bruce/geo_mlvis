...
np$save(file.path(out_dir, str_c("x-test",B, ".npy")), patch$x)
np$save(file.path(out_dir, str_c("x_equal-test",B, ".npy")), patch$x_equal)
np$save(file.path(out_dir, str_c("y-test",B,".npy")), patch_y)
