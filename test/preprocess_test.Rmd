...
np$save(file.path(out_dir, str_c("x-", test, ".npy")), patch$x)
np$save(file.path(out_dir, str_c("x_equal-", test, ".npy")), patch$x_equal)
np$save(file.path(out_dir, str_c("y-", test, ".npy")), patch_y)
